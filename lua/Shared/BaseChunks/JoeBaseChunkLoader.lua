...
CreateDefaultJoeBaseChunkLoader = function()
    ...
    local ok, msg = pcall(
        function()
            ...
            -- baseChunkManager:LoadTemplate("/mods/fa-joe-ai/lua/Shared/BaseChunks/Templates/air_16x16_01.lua")
            -- baseChunkManager:LoadTemplate("/mods/fa-joe-ai/lua/Shared/BaseChunks/Templates/power_08x08_01.lua")
            baseChunkManager:LoadTemplate("/mods/fa-joe-ai/lua/Shared/BaseChunks/Templates/power_16x16_01.lua")
            baseChunkManager:LoadTemplate("/mods/fa-joe-ai/lua/Shared/BaseChunks/Templates/power_16x16_02.lua")
            -- baseChunkManager:LoadTemplate("/mods/fa-joe-ai/lua/Shared/BaseChunks/Templates/special_08x08_01.lua")
            -- baseChunkManager:LoadTemplate("/mods/fa-joe-ai/lua/Shared/BaseChunks/Templates/special_08x08_02.lua")
            -- baseChunkManager:LoadTemplate("/mods/fa-joe-ai/lua/Shared/BaseChunks/Templates/special_16x16_01.lua")
            -- baseChunkManager:LoadTemplate("/mods/fa-joe-ai/lua/Shared/BaseChunks/Templates/land_16x16_01.lua")
            -- baseChunkManager:LoadTemplate("/mods/fa-joe-ai/lua/Shared/BaseChunks/Templates/land_16x16_02.lua")
            -- baseChunkManager:LoadTemplate("/mods/fa-joe-ai/lua/Shared/BaseChunks/Templates/land_32x32_01.lua")
            -- baseChunkManager:LoadTemplate("/mods/fa-joe-ai/lua/Shared/BaseChunks/Templates/land_32x32_02.lua")
            -- baseChunkManager:LoadTemplate("/mods/fa-joe-ai/lua/Shared/BaseChunks/Templates/random_32x32_01.lua")
            baseChunkManager:LoadTemplate("/mods/fa-joe-ai/lua/Shared/BaseChunks/Templates/Large_UEF_base_Chunk_222.lua")
            baseChunkManager:LoadTemplate("/mods/fa-joe-ai/lua/Shared/BaseChunks/Templates/untitled-f9oxfw0i6w.lua")
        end
    )
